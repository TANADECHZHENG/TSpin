  ...
  return (
        <div className='h-full flex justify-center items-center'>
          <div className='flex flex-col gap-10 justify-center items-center z-0'>
            ...
            <button className='text-xl flex justify-center items-center bg-yellow-400 px-16 py-2 rounded-2xl shadow-lg border border-black hover:bg-yellow-200'>
                <Link href='/sign-in' className='text-yellow-950 font-bold text-xl'>Log In</Link>
            </button>
          </div>
        </div>
  );
